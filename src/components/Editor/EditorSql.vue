...
import vCompletion from './completion'
export default {
    props:{
        codes:{
            type:String,
    ...
    methods:{
        initEditor(){
            ...
            // monaco.editor.languages.registerCompletionItemProvider('sql', {        provideCompletionItems: () => {          return { suggestions: vCompletion }        }      })
